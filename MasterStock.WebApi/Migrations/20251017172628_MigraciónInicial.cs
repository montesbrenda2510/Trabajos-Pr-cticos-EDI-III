        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TipodeMovimiento = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Codigo = table.Column<int>(type: "int", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "MovimientosdeStocks",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Idproducto = table.Column<int>(type: "int", nullable: false),
                    TipodeMoviviento = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovimientosdeStocks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MovimientosdeStocks_Productos_Idproducto",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovimientosdeStocks_Idproducto",
                table: "MovimientosdeStocks",
                column: "Idproducto");
